    ...
    return (
      <PageHeaderWrapper
        title={
          action === 'create'
            ? intl.formatMessage({
                id: 'app.newAgent.title',
                defaultMessage: 'Create Agent',
              })
            : intl.formatMessage({
                id: 'app.editAgent.title',
        ...
        <Card bordered={false} loading={action === 'edit' ? loadingAgent : false}>
          ...
          >
              ...
              rules={[
                {
                  required: false,
                  message: intl.formatMessage({
                    id: 'app.newAgent.required.image',
            ...
            <FormItem
              {...formItemLayout}
              label={intl.formatMessage({
                id: 'app.newAgent.label.agentCapacity',
              ...
              rules={[
                {
                  required: false,
                  message: intl.formatMessage({
                    id: 'app.newAgent.required.agentCapacity',
            ...
            <FormItem
              {...formItemLayout}
              label={intl.formatMessage({
                id: 'app.newAgent.label.nodeCapacity',
              ...
              rules={[
                {
                  required: false,
                  message: intl.formatMessage({
                    id: 'app.newAgent.required.nodeCapacity',
            ...
            <FormItem
              {...formItemLayout}
              label={intl.formatMessage({
                id: 'app.newAgent.label.configFile',
            ...
            >
              <Upload {...uploadProps}>
                <Button>
                  <UploadOutlined />
                  {intl.formatMessage({
                    id: 'app.newAgent.label.configFileSelect',
            ...
            <FormItem
              {...formItemLayout}
              label={intl.formatMessage({
                id: 'app.newAgent.label.logLevel',
              ...
              rules={[
                {
                  required: false,
                  message: intl.formatMessage({
                    id: 'app.newAgent.required.LogLevel',
            ...
            <FormItem
              {...formItemLayout}
              label={intl.formatMessage({
                id: 'app.newAgent.label.schedulable',
