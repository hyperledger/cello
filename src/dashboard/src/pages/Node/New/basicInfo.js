        ...
        >
          <Form.Item
            ...
            label={intl.formatMessage({
              id: 'app.node.new.inputBasic.form.networkType.label',
            ...
            rules={[
              {
                ...
                message: intl.formatMessage({
                  id: 'app.node.new.inputBasic.form.networkType.required',
          ...
          >
            <Select
              placeholder={intl.formatMessage({
                id: 'app.node.new.inputBasic.form.networkType.placeholder',
          ...
          <Form.Item
            ...
            wrapperCol={{ span: 15 }}
            label={intl.formatMessage({
              id: 'app.node.new.inputBasic.form.agentType.label',
            ...
            rules={[
              {
                required: true,
                message: intl.formatMessage({
                  id: 'app.node.new.inputBasic.form.agentType.required',
          ...
          >
            <Select
              placeholder={intl.formatMessage({
                id: 'app.node.new.inputBasic.form.agentType.placeholder',
          ...
          <Form.Item
            ...
            wrapperCol={{ span: 15 }}
            label={intl.formatMessage({
              id: 'app.node.new.inputBasic.form.networkVersion.label',
            ...
            rules={[
              {
                required: true,
                message: intl.formatMessage({
                  id: 'app.node.new.inputBasic.form.networkVersion.required',
          ...
          >
            <Select
              placeholder={intl.formatMessage({
                id: 'app.node.new.inputBasic.form.networkVersion.placeholder',
          ...
          <Form.Item
            ...
            wrapperCol={{ span: 15 }}
            label={intl.formatMessage({
              id: 'app.node.new.inputBasic.form.nodeType.label',
            ...
            rules={[
              {
                required: true,
                message: intl.formatMessage({
                  id: 'app.node.new.inputBasic.form.nodeType.required',
          ...
          >
            <Select
              placeholder={intl.formatMessage({
                id: 'app.node.new.inputBasic.form.nodeType.placeholder',
