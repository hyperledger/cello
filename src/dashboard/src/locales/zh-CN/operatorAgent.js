export default {
  ...
  'app.operator.agent.form.release.title': '释放代理',
  'app.operator.agent.form.delete.content': '确认删除代理 {name}?',
  'app.operator.agent.form.release.content': '确认释放代理 {name}?',
  'app.operator.agent.delete.success': '删除代理成功。',
  'app.operator.agent.release.success': '释放代理成功.',
  ...
  'app.operator.applyAgent.title': '申请代理',
  'app.operator.applyAgent.success': '申请代理成功。',
};
