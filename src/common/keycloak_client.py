...
class KeyCloakClient(object):
    def __init__(self, admin_name=KEYCLOAK_ADMIN_NAME,
    ...
    def get_user(self, username=""):
        ...
        ret = requests.get(self._users_url,
    ...
    def update_user(self, user_id="", body=None):
        ...
        ret = requests.put("%s/%s" % (self._users_url, user_id),
    ...
    def reset_user_password(self, user_id="", password=""):
        ...
        ret = requests.put("%s/%s/reset-password" % (self._users_url, user_id),
    ...
    def _get_client_id(self, name):
        ...
        ret = requests.get(self._clients_url,
                           params=params,
                           headers=self._headers)
        client = ret.json()[0]
    ...
    def get_client(self, name=""):
        ...
        ret = requests.get("%s/%s" % (self._clients_url, client_id),
                           headers=self._headers)
    ...
    def update_client(self, name="", body=None):
        ...
        ret = requests.put("%s/%s" % (self._clients_url, client_id),
                           data=json.dumps(body), headers=self._headers)
        print(ret.text, ret.status_code)
    ...
    def create_new_client_scopes(self, body=None):
        ...
        ret = requests.post(self._client_scopes_url, data=json.dumps(body),
                            headers=self._headers)
        print(ret.text, ret.status_code)
    ...
    def create_user(self, body=None):
        ...
        ret = requests.post(self._users_url, data=json.dumps(body),
                            headers=self._headers)
        print(ret.text, ret.status_code)
    ...
    def delete_user(self, user_id=None):
        ...
        ret = requests.delete("%s/%s" % (self._users_url, user_id),
                              headers=self._headers)
        print(ret.text, ret.status_code)
    ...
    def create_new_client(self, name="", url="", default_client_scopes=None):
        ...
        ret = requests.post(self._clients_url,
                            data=json.dumps(body),
                            headers=self._headers)
        ...
        ret = requests.get("%s/%s/client-secret" %
                           (self._clients_url, client_id),
                           headers=self._headers)
        data = ret.json()
    ...
    def get_realm(self, name=""):
        ret = requests.get("%s/auth/admin/realms/%s" % (self._base_url, name),
                           headers=self._headers)
        return ret.json()
    ...
    def update_realm(self, name="", body=None):
        ...
        ret = requests.put("%s/auth/admin/realms/%s" % (self._base_url, name),
                           data=json.dumps(body),
                           headers=self._headers)
        print(ret.text, ret.status_code)
    ...
    def create_realm(self, body=None):
        ...
        ret = requests.post("%s/auth/admin/realms/" % self._base_url,
                            headers=self._headers,
                            data=json.dumps(body))
