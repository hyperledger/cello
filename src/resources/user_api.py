...
from modules.user import ListUser, CreateUser, UpdateUser, \
    DeleteUser, Register, Login, UserInfo, UserProfile, UserSearch,ResetPassword,ChangePassword
...
user_api.add_resource(ResetPassword, '/resetPassword/<string:username>')
user_api.add_resource(ChangePassword, '/<string:user_id>/changePassword')
